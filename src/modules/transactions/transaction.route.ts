...
router.get("/commissions", requireAuth, requireRole(UserRole.AGENT), getMyCommissions);

// Admin only - all transactions
router.get("/admin/all", requireAuth, requireRole(UserRole.ADMIN), getAllTransactions);
